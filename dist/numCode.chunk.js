...
var Fn = function () {
    ...
    _createClass(Fn, [{
        key: "ye",
        value: /*#__PURE__*/_regenerator2.default.mark(function ye(arr) {
            var _this, i;

            return _regenerator2.default.wrap(function ye$(_context) {
                while (1) {
        ...
        key: "ctxFont",
        value: function ctxFont() {
            var _this = this;
            var ctx = _this.ctx;
            var bgGradient = ctx.createLinearGradient(0, 0, _this.width, 0);
            ...
            var textWidth = ctx.measureText(_this.font).width;
            var x = parseInt((_this.width - textWidth) / 2);
            var y = 30;
        ...
        value: function getNumber(num) {
            ...
            try {
                for (var _iterator = _this.ye(arr)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    var x = _step.value;
